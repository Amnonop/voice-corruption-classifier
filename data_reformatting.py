...
def stft(sig, frame_size, overlap_factor=0.95, window=np.hanning):
...
ims = plot_audio_spectrogram(filename, 2**11, output_folder + '/'+ ntpath.basename(filename.replace('.wav','')) + '.png',  'l')
